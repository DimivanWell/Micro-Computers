...
;PORTB_Init
    ...
    ;STR R0, [R1]                    
    ;LDR R1, =GPIO_PORTB_PDR_R       ; 8) pull-down resistors for PB0 and PB1
    ;MOV R0, #0x30                   
    ;STR R0, [R1]                  
...
;PORTB_Input
    ...
    ;LDR R0, [R1]               ; read all of Port B
    ;AND R0,R0,#0x30            ; just the input pins PB0 and PB1
    ;BX  LR                     ; return R0 with inputs

;;------------PORTB_Output------------
;PORTB_Output
    ;LDR R1, =GPIO_PORTB_DATA_R ; pointer to Port B data
    ;STR R0, [R1]               ; write to PB2
    ;BX  LR                    
